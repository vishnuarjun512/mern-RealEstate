      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1">
          ...
          <button
            ...
            className="my-2 p-3 bg-gray-600 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80"
          >
            {loading ? "Creating .... " : "Create Listing"}
          </button>
          {error && (
            <p className="text-red-500 text-center p-2 text-sm">{error}</p>
          )}
        </div>
      </form>
    </main>
